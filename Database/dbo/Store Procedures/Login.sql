...
END
ELSE IF  NOT EXISTS( SELECT * FROM Usuarios WHERE Usuario=@Usuario and Contrasena=@Contrasena AND Estado =1) BEGIN
 
 SELECT -1 AS CodeError, 'La contraseña es incorrecta porfavor volver a intentar!' AS MsgError
END
ELSE BEGIN
